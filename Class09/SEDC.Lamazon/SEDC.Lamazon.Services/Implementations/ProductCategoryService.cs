...
namespace SEDC.Lamazon.Services.Implementations
{
    public class ProductCategoryService : IProductCategoryService
    {
        ...
        {
            var productCategory = _productCategoryRepository.Get(x => x.Id == id);
        ...
        private void ValidateCategory(string name)
        {
            ...
            var productCategory = _productCategoryRepository.Get(x => x.Name.ToLower() == name.ToLower());
            ...
            var productCategoryContains = _productCategoryRepository.Get(x => x.Name.ToLower().Contains(name.ToLower()));
